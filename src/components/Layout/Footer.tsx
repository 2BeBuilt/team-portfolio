      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://github.com/orgs/2bebuilt"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-neo-white hover:text-neo-lime transition-colors"
            >
              ...
              <span className="text-xs font-bold">2BeBuilt</span>
            </a>
            <a
              href="https://github.com/orgs/2bb-dev"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-neo-white hover:text-neo-lime transition-colors"
            >
              ...
              <span className="text-xs font-bold">2bb-dev</span>
            </a>
          </div>
